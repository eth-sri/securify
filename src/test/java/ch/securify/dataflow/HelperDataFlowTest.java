...
import ch.securify.patterns.AbstractInstructionPattern;
import ch.securify.patterns.AbstractPattern;
import ch.securify.patterns.HelperTestInput;

import java.io.IOException;
import java.util.List;

public class HelperDataFlowTest {
    ...
    public HelperDataFlowTest(String hexFilename) throws IOException {
